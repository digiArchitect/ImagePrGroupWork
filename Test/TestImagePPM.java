...
public class TestImagePPM {
 ...
 public void setUp() {
   ...
   s = new ImagePPM(lol,2,2,255);
   u = new ImagePPM(peter,2,1,255);
   p = new ImagePPM(griffin, 1,1,100);
   e = new ImagePPM(family,2,4,0);
   r = new ImagePPM(guy,4,2,30);
 }
  @Test(expected = IllegalArgumentException.class)
  public void nullImageVals() {
   new ImagePPM(null,1,1,5);}
  @Test(expected = IllegalArgumentException.class)
  public void smallWidth() {
    new ImagePPM(lol,0,1,5);}
  @Test(expected = IllegalArgumentException.class)
  public void smallHeight() {
    new ImagePPM(lol,1,0,5);}
  @Test(expected = IllegalArgumentException.class)
  public void smallMaxValue() {
    new ImagePPM(lol,1,1,-1);}
  @Test(expected = IllegalArgumentException.class)
  public void allBadParens() {
    new ImagePPM(null,0,0,-1);}
